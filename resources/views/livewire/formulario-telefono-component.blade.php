        ...
        <x-jet-form-section submit="guardar">
            ...
            <x-slot name="form">
                ...
                <div class="col-span-6 sm:col-span-4">
                    ...
                    <x-jet-input id="numero" type="text" class="mt-1 block w-full" wire:model.defer="telefono.numero" />
                ...
                <div class="col-span-6 sm:col-span-4">
                    ...
                    <select wire:model.defer="telefono.operadora" name="operadora" class="w-full" id="operadora">
